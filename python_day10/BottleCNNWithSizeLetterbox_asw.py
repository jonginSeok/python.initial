...
from BottleCNNWithSizeLetterbox import BottleCNNWithSize, Letterbox, transform
...
# 모델 저장 (학습 루프 끝난 후)
save_path = data_path + '/model/bottle_cnn_with_size_letterbox.pth'
...
predict_image('C:/Users/ngins/Git/python.initial/python_day12/classification/Bottle/test/good/001.jpg')  # 실제 파일 경로 지정
