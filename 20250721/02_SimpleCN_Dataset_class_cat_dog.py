...
data_path = "/Users/ngins/Git/python.initial/dataset/cat_dog"
...
optimizer = optim.Adam(model.parameters(), lr=LR)   # AdamW, SGD 등 다른 옵티마이저도 사용 가능
...
# 7. 모델 로드 (예시)
model.load_state_dict(torch.load("cat_dog_cnn.pth", map_location=DEVICE))  # weights_only=True # PyTorch 2.0 이상에서 사용 가능
model.eval()
